...
const LETTER_PARAGRAPHS = [
  ...
  "Terima kasih, Mass...",
  "Terima kasih karena telah menerima aziz ketika aziz tidak memiliki apa-apa untuk dibanggakan.<br>Terima kasih karena tetap menghargai aziz saat aziz dipenuhi kekurangan.<br>Terima kasih karena tidak menjauh ketika aziz berada di titik terburuk dalam hidup.<br>Terima kasih karena tetap percaya kepada aziz saat aziz sendiri bahkan sulit percaya pada diri aziz sendiri.",
  "Mungkin mas ngga pernah sadar, ada banyak hari yang aziz lalui terasa lebih ringan karena kehadiran mas.<br>Ada banyak luka yang terasa lebih tenang karena nasihat mas.<br>Ada banyak masalah yang tidak jadi membuat aziz jatuh karena aziz tahu masih ada seseorang yang menerima aziz apa adanya.",
  "Di dunia yang begitu mudah menghakimi, Mas memilih memahami.<br>Di dunia yang begitu mudah meninggalkan, mas memilih bertahan.<br>Di dunia yang sering menilai dari kelebihan, mas menerima bahkan saat melihat kekurangan aziz.",
  "Dan jujur, Mas...",
  ...
  "Karena tidak semua orang beruntung memiliki saudara kandung yang baik.<br>Tetapi Allah menghadirkan seseorang yang tidak terikat darah, namun mampu memberikan kasih sayang, perhatian, kesabaran, dan ketulusan layaknya seorang abang kandung.",
  ...
  "Saat orang lain hanya melihat aziz ketika aziz berhasil, mas mengenal aziz saat aziz jatuh.<br>Saat orang lain datang karena keadaan baik, mas tetap ada bahkan ketika keadaan buruk.<br>Dan itu adalah kebaikan yang tidak akan pernah bisa aziz balas dengan apa pun.",
  ...
  "Semoga Allah menjaga setiap langkah mas.<br>Semoga setiap air mata yang pernah mas sembunyikan diganti dengan kebahagiaan yang berlipat.<br>Semoga setiap kebaikan yang mas berikan kepada orang lain kembali kepada mas dengan cara yang paling indah.<br>Semoga Allah melapangkan rezeki, menguatkan hati, menjaga keluarga, mengangkat derajat, dan mengabulkan seluruh doa terbaik mas.<br>Dan semoga mas dan mba selalu menjadi keluarga sakinah, mawadah dan warahmah selamanya. Dan semoga Allah segera memberikan amanah terindah sesosok kehadiran buah hati untuk mas dan mba. Aamiin allahumma aamiin",
  ...
  "Once more..<br>Selamat ulang tahun, Mas.",
